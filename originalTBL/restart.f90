...
do my_rank=0,proc-1
	...
	read(12,*)
		...
		read(12,*)
			do k=istart,iend
				read(12,97)x1(i),x2(j),x3(k),Ut(i,j,k,1),Ut(i,j,k,2),Ut(i,j,k,3),Ut(i,j,k,4),Press(i,j,k)!,usum2(i,k),vsum2(i,k),wsum2(i,k),Ufluc(i,j,k,1),Ufluc(i,j,k,2),Ufluc(i,j,k,3),Wt(i,k),new(k)
			enddo
		enddo
	enddo
	close(12)
...
write(12,*)'Variables = "x","y","z","U","V","W","T","P"'!,"Um","Vm","Wm","Uf","Vf","Wf","Wt","Nk"'
...
do i=1,nX
	...
	do j=1,nY
		write(12,*)
		do k=1,nZ
			WRITE(12,97)x1(i),x2(j),x3(k),Ut(i,j,k,1),Ut(i,j,k,2),Ut(i,j,k,3),Ut(i,j,k,4),Press(i,j,k)!,usum2(i,k),vsum2(i,k),wsum2(i,k),Ufluc(i,j,k,1),Ufluc(i,j,k,2),Ufluc(i,j,k,3),Wt(i,k),new(k)
		enddo
	enddo
enddo
close(12)
